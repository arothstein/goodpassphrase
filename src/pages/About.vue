    ...
    <div class="q-pa-md full-width full-height column">
      <div class="row">
        <div class="col-12">
          ...
          <h2 class="text-h4">What is Diceware?</h2>
          ...
          <p>
            ...
            <a href="https://www.eff.org/files/2016/07/18/eff_large_wordlist.txt">large wordlist</a>. For a deep dive on this word list and the math which lets us determine the average time to guess a password, read
            <a
          ...
          <p>
            ...
            >Azure AD's password policy</a> as a reference for allowed characters:
            <br />
            @ # $ % ^ & * - _ ! + = [ ] { } | \ : ' , . ? / ` ~ " ( ) ;
          </p>
          ...
          <p>
            ...
            >Diceware-Passphrase Complexity Calcuations | docs.google.com</a>
          </p>
        </div>
      </div>
    </div>
